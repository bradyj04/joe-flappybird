//check if nft cookie exists
if(document.cookie.indexOf("nft=") == -1) {
    if(confirm("Invalid NFT image URL, Press OK to exit and fix the NFT URL.")) {
    ...
    //remove nft cookie
document.cookie = "nft=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
